...
const blank = () => {
  ...
  utilities:{electricOn:'',electricServiceType:'',electricProvider:'',electricProviderOther:'',electricMeterLocation:'',mainDisconnectLocation:'',electricMeterFireDamage:'',gasOn:'',fuelType:'',gasProvider:'',gasMeterLocation:'',gasRiserLocation:'',gasMeterDamage:'',gasRiserDamage:'',gasNotes:'',lpTank:'',lpSupplier:'',lpTankSize:'',lpLocation:'',lpTankOrientation:'',lpPercentProduct:'',lpRegulatorCount:'',lpTankFireDamage:'',lpNotes:'',generatorPresent:'',generatorLocation:'',generatorFuelType:'',generatorNotes:'',batteryStoragePresent:'',batteryStorageLocation:'',batteryType:'',batteryStorageNotes:'',waterOn:'',waterProvider:'',waterShutoffLocation:'',notes:''},
...
function render(screen=current){
  ...
  const map={dashboard,initial,scene,building,utilities,electrical,exterior,roof,interior,people,vehicles,machinery,rooms,photos,evidence,interviews,reports,files};
