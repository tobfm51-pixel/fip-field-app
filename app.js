...
function render(screen=current){
  ...
  const map={dashboard,initial,scene,building,exterior,roof,interior,people,vehicles,machinery,rooms,photos,evidence,interviews,reports,files};
